...
legend_html = "<div><b>Meteorite Classification Color Key:</b><br>"
for classification, color in classification_colors.items():
    legend_html += f"<div style='margin-top: 3px;'><span style='display:inline-block; width:20px; height:10px; background:{color};'></span> {classification}</div>"
legend_html += "</div>"
